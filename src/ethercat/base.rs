...
pub mod ec_ver1 {
    ...
    use crate::{
        ethercat::r#type::{Buffer, CommandType},
    ...
    pub fn bwr(
        ...
        super::bwr(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn brd(
        ...
        super::brd(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn aprd(
        ...
        super::aprd(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn frmw(
        ...
        super::frmw(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn aprdw(
        ...
        super::aprdw(port, address_position, address_offset, timeout)
    }
    ...
    pub fn fprd(
        ...
        super::fprd(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn fprdw(
        ...
        super::fprdw(port, address_position, address_offset, timeout)
    }
    ...
    pub fn apwrw(
        ...
        super::apwrw(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn apwr(
        ...
        super::apwr(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn fpwrw(
        ...
        super::fpwrw(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn fpwr(
        ...
        super::fpwr(port, address_position, address_offset, data, timeout)
    }
    ...
    pub fn lrw(
        ...
        super::lrw(port, logical_address, data, timeout)
    }
    ...
    pub fn lrd(
        ...
        super::lrd(port, logical_address, data, timeout)
    }
    ...
    pub fn lwr(
        ...
        super::lwr(port, logical_address, data, timeout)
    }
